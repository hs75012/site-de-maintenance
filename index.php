<?php
    ...
    'Messages' => [
      [
        ...
        'HTMLPart' => "<h3>Dear $name 1, welcome to <a href='https://www.mailjet.com/'>Mailjet</a>!</h3><br />May the delivery force be with you!",
        'CustomID' => "AppGettingStartedTest"
      ]
      ]
  ];
  die(var_dump($name, $subject, $message, $email));
